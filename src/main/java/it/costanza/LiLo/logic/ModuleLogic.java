...
public class ModuleLogic {
	...
	/**
	 * Controlla se l'idModuloType esiste ed � dell'utente che vuole visualizzarlo.
	 * Se il moduloType non � visualizzabile per l'utente in questione viene lanciata un eccezione	
	 * @param user utente che ambisce a visualizzare il modulo
