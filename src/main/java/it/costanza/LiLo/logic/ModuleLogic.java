...
public class ModuleLogic {
	 ...
	 * Dappirma se non Ã¨ presente si salva il modulo dayHost necessario al funzionamento del diario, successivamente
	 * si salva il modulo. I campi non presenti vengono annullati. Se giÃ  presente una dayHost viene usato quello per il salvataggio.
