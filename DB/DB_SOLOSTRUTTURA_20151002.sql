...
--
-- Host: localhost
-- Generato il: Ott 02, 2015 alle 16:45
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='TABELLA CHE CONTIENE GLI ID DEI CONTENUTI LISTA DEI MODULI' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `modules_header` (
  ...
  KEY `FK_ID_MODULE_TYPE_IDX` (`ID_MODULE_TYPE`),
  KEY `ID_USER` (`ID_USER`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='LA TABELLA CONTIENE I MODULI, QUI VANNO GLI ID LEGATI ALLE A' AUTO_INCREMENT=46 ;
...
CREATE TABLE IF NOT EXISTS `modules_types` (
  ...
  KEY `FK_ID_USER_IDX` (`ID_USER`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='TABELLA CHE DEFINISCE I MODULI.' AUTO_INCREMENT=15 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='TABELLA CHE CONTIENE LE IMPOSTAZIONI DEGLI UTENTI.' AUTO_INCREMENT=42 ;
